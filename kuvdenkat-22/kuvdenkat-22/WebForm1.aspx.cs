    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GridView1.DataSource = (from student in employeeDBContext.Students
                                   ...
                                   }).ToList();     //VAŽNO dodati .ToList() jer inače prijavljuje neku bezveze grešku
        GridView1.DataBind();
        }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            EmployeeDBContext employeeDBContext = new EmployeeDBContext();
            Course SQLCourse = employeeDBContext.Courses.FirstOrDefault(x => x.CourseID == 3);

            employeeDBContext.Students.Include("Courses").FirstOrDefault(x => x.StudentID == 2).Courses.Remove(SQLCourse);
            employeeDBContext.SaveChanges();
        }
    }
}